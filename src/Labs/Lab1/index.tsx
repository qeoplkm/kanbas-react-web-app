  ...
  return (
    <div id="wd-lab1">
      ...
      <ol id="wd-my-favorite-recipe">
        <li>Beat the egg and mix it with the rice in a bowl.</li>
        <li>Cut the ham sausage into small pieces.</li>
        <li>Heat oil in a pan over medium heat.</li>
        <li>Add the cut ham sausage and egg to the pan.</li>
        <li>Pour the egg and rice mixture into the pan.</li>
        <li>Stir and cook until the egg is fully cooked and the rice is heated through.</li>
      </ol>
