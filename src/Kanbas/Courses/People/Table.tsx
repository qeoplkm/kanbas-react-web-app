      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Jeremy</span>{" "}
              <span className="wd-last-name">Yao</span>
            </td>
            <td className="wd-login-id">001332312S</td>
            <td className="wd-section">S102</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-9-01</td>
            <td className="wd-total-activity">13:11:45</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-login-id">001421561S</td>
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Shuai</span>{" "}
              <span className="wd-last-name">Yao</span>
            </td>
            <td className="wd-login-id">001345214S</td>
